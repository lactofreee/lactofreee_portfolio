...
export default function SocialLinks() {
  return (
    <div className="hidden md:flex fixed left-8 bottom-0 flex-col items-center gap-5 z-10">
      ...
      <span
        className={[
          ...
          'opacity-0 animate-fade-in-up [animation-delay:500ms]',
        ].join(' ')}
      />
    </div>
  );
